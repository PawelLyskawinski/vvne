...
// -----------------------------------------------------------------------------
// Single push constant structure in this stage
// -----------------------------------------------------------------------------
...
//
// Physically Based Rendering Material (only textures)
//
// ordering:
// 0. albedo
...
//
layout(set = 3, binding = 0) uniform LightSourcesUbo
{
  vec4 positions[64];
  vec4 colors[64];
  int  count;
...
//
layout(set = 4, binding = 0) uniform CascadeShadowMappingUBO
{
