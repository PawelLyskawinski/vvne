...
#define LINMATH_H_DEFINE_VEC(n)                                                                                                                                \
  ...
  {                                                                                                                                                            \
    return SDL_sqrtf(vec##n##_mul_inner(v, v));                                                                                                                \
  }                                                                                                                                                            \
...
static inline void mat4x4_perspective(mat4x4 m, float y_fov, float aspect, float n, float f)
{
  ...
  float const a = 1.f / SDL_tan(y_fov / 2.f);
...
{
  vec3 v;
  vec3_scale(v, axis, SDL_sinf(angle / 2));
  int i;
  for (i = 0; i < 3; ++i)
    r[i] = v[i];
  r[3] = SDL_cosf(angle / 2);
}
...
static inline void quat_from_mat4x4(quat q, mat4x4 M)
{
  ...
  r = SDL_sqrtf(1.f + M[p[0]][p[0]] - M[p[1]][p[1]] - M[p[2]][p[2]]);
